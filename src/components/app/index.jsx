  ...
  return (
    ...
    >
      ...
      <div style={Instructions}>
        ...
        <p>
          Just move that pesky map maker to the side and you will see him. While
          you are at it, create a world with that map maker. (use your arrow
          keys to walk the cat)
        </p>
      </div>
      <TilePalette
        position={position}
